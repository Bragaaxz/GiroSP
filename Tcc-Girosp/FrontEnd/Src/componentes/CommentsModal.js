...
type Props = { comments: LocalComment[]; onClose: () => void; onSubmit: (text: string) => void; visible: boolean };

export function CommentsModal({ comments, onClose, onSubmit, visible }: Props) {
