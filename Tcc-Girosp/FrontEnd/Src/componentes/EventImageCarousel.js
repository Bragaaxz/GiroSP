import { Image, ImageSourcePropType, NativeScrollEvent, NativeSyntheticEvent, ScrollView, StyleSheet, View } from 'react-native';
import { useState } from 'react';

type Props = { images: ImageSourcePropType[]; width: number; title: string };

export function EventImageCarousel({ images, width, title }: Props) {
